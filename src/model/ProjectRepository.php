...
class ProjectRepository {
    public function getAll(){
        ...
        $javascript->add(new Project("Desktop Application", "http://erikhamrin.se/projects/lnu/1dv403/5-pwd/", "En fönsterhanterare som har ett antal inbyggda applikationer. Detta är slutprojekt i kursen Webteknik I på LNU.", "https://github.com/ehamrin/1dv403-laborationer/tree/master/5-pwd"));

        $csharp = new ProjectList("C#");
        $csharp->add(new Project("Räkna på löner", "https://github.com/ehamrin/1dv402-eh222ve-1-3-salaries/blob/master/_1DV402.S1.L03C/Program.cs", "En konsolapplikation för uträkning av medianlön, medellön samt spridning."));
        $csharp->add(new Project("Geometriska former", "https://github.com/ehamrin/1dv402-eh222ve-2-3-shapes/blob/master/_1DV402.S2.L03C/Program.cs", "En konsolapplikation för uträkning mått, volym m.m. på 2D- och 3D-former."));
